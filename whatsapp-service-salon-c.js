...
// Load/Save/Update connection status functions
...
app.post('/reset-connection', (req, res) => {
    try {
        ...
        const sessionPath = `.wwebjs_auth/session-salon-c-client`;
    ...
    if (connectionStatus.is_connected && isReady) {
        ...
        res.send(`
            ...
            <head>
                ...
                <style>
                    body { font-family: Arial, sans-serif; text-align: center; padding: 50px; background: #f0e6ff; }
