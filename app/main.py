            ...
            return HTMLResponse(content=f"""
                ...
                <head>
                    ...
                    <script>
                        ...
                        // Track that user accessed Uptown Hair Studio QR page
                        if (typeof(Storage) !== "undefined") {{
                            localStorage.setItem("preferred_salon", "salon_b");
                            localStorage.setItem("salon_name", "Uptown Hair Studio");
                            localStorage.setItem("qr_access_time", new Date().toISOString());
                            console.log("🎯 Set salon preference: salon_b");
                        }}
            ...
            return HTMLResponse(content=f"""
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="special-command">
                            <h3>🎯 Automatic Salon Detection</h3>
                            <p><strong>Great news!</strong> When you scan this QR code and send your first message, you'll be automatically connected to Luxury Spa & Salon.</p>
                            <p style="font-size: 1.3em; font-weight: bold; color: #4CAF50;">✅ Just send "hi" - no special commands needed!</p>
                            <p>Our system will detect that you accessed this salon's QR page.</p>
                        </div>
                        ...
                        <div class="instructions">
                            ...
                            <ol style="text-align: left; max-width: 400px; margin: 0 auto;">
                                ...
                                <li>Tap "Link a Device" and scan</li>
                                <li><strong>Send "hi"</strong> - you'll automatically connect to this salon</li>
                                <li>You'll only see Luxury Spa & Salon services and specialists</li>
                            </ol>
                        </div>
                    </div>
                </body>
